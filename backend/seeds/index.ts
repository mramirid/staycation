...
export type SeedResult = {
  categories: {
    houses: CategoryDoc;
    hotels: CategoryDoc;
    apartments: CategoryDoc;
  };
  properties: {
    tabbyTown: PropertyDoc;
    seattleRain: PropertyDoc;
  };
  banks: {
    bsi: BankDoc;
    bsm: BankDoc;
  ...
  bookings: {
    elfinBooking: BookingDoc;
    yeinBooking: BookingDoc;
  };
  users: {
    mramirid: UserDoc;
  };
...
export async function seed(): Promise<SeedResult> {
  const [houses, hotels, apartments] = await Category.insertMany([
    { name: "Houses with beauty backyard" },
    { name: "Hotels with large living room" },
    { name: "Apartments with kitchen" },
  ]);
  ...
  await Booking.insertMany([elfinBooking, yeinBooking]);
  ...
  return {
    ...
    properties: { tabbyTown, seattleRain },
    banks: { bsi, bsm },
    bookings: { elfinBooking, yeinBooking },
    users: { mramirid },
  };
}
